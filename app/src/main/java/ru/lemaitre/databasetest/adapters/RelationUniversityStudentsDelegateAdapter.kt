...
class RelationUniversityStudentsDelegateAdapter(
    private val onItemClick: (position: Int) -> Unit
) :
    AbsListItemAdapterDelegate<Entities.RelationUniversityStudents, Entities, RelationUniversityStudentsDelegateAdapter.EntitiesHolder>() {


    override fun isForViewType(item: Entities, items: MutableList<Entities>, position: Int): Boolean {
        return item is Entities.RelationUniversityStudents
    }
    ...
    override fun onBindViewHolder(
        item: Entities.RelationUniversityStudents,
    ...
    class EntitiesHolder(
        ...
        fun bind(screen: Entities.RelationUniversityStudents) {
